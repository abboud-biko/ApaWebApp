...
public class RessourceMarine {
	...
	@Column(name="mer_profondeur")
	private String mer_profondeur;
	
	@Column(name="mer_temperature")
	private String mer_temperature;
	...
	public String getMer_profondeur() {
		return mer_profondeur;
	}

	public void setMer_profondeur(String mer_profondeur) {
		this.mer_profondeur = mer_profondeur;
	}

	public String getMer_temperature() {
		return mer_temperature;
	}

	public void setMer_temperature(String mer_temperature) {
		this.mer_temperature = mer_temperature;
	}
